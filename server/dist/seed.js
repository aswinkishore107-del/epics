...
function generateSyntheticECG(pointsCount = 300) {
    const points = [];
...
async function main() {
    ...
    const passwordHash = await bcryptjs_1.default.hash('VioraDemo123!', 10);
    // 2. Create Users
    ...
    const elderlyUser = await prisma.user.create({
        data: {
            ...
            passwordHash,
            role: client_1.UserRole.ELDERLY,
            firstName: 'Rajesh',
            lastName: 'Kumar',
    ...
    const device = await prisma.device.create({
        data: {
            ...
            wifiStatus: client_1.ConnectionStatus.CONNECTED,
            bluetoothStatus: client_1.ConnectionStatus.CONNECTED,
            isSimulated: true,
        },
    });
    ...
    await prisma.safetyRule.createMany({
        data: [
            {
                metric: client_1.MetricType.HEART_RATE,
                operator: client_1.RuleOperator.GREATER_THAN,
                threshold: 120,
            ...
            {
                metric: client_1.MetricType.HEART_RATE,
                operator: client_1.RuleOperator.LESS_THAN,
                threshold: 50,
                severity: client_1.SeverityLevel.WARNING,
                enabled: true,
            ...
            {
                metric: client_1.MetricType.SPO2,
                operator: client_1.RuleOperator.LESS_THAN,
                threshold: 95,
                severity: client_1.SeverityLevel.WARNING,
                enabled: true,
            ...
            {
                metric: client_1.MetricType.SKIN_TEMPERATURE,
                operator: client_1.RuleOperator.GREATER_THAN,
                threshold: 37.8,
                severity: client_1.SeverityLevel.WARNING,
                enabled: true,
            ...
            {
                metric: client_1.MetricType.RESPIRATORY_RATE,
                operator: client_1.RuleOperator.GREATER_THAN,
                threshold: 22,
                severity: client_1.SeverityLevel.WARNING,
                enabled: true,
    ...
    await prisma.respiratoryReading.create({
        data: {
            ...
            rate: 16,
            depth: 'NORMAL',
            method: client_1.MeasurementSource.ECG_DERIVED_RESPIRATION,
            isSimulated: true,
            timestamp: now,
        },
    });
        ...
        data: [
            {
                ...
                status: client_1.MedicationStatus.TAKEN,
                loggedBy: 'PATIENT',
    ...
    await prisma.reminder.createMany({
        data: [
            ...
            },
            {
                ...
                category: client_1.ReminderCategory.ACTIVITY,
            ...
            },
            {
                ...
                category: client_1.ReminderCategory.MEDICATION,
        ...
        data: [
            {
                ...
                type: client_1.NotificationType.MEDICATION,
                isRead: true,
            },
            {
                userId: caregiverUser.id,
                ...
                type: client_1.NotificationType.HEALTH_UPDATE,
                isRead: false,
            },
            {
                userId: doctorUser.id,
